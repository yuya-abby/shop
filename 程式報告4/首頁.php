...
<div style="position: fixed; bottom: 0; right: 0; padding: 10px; font-size: 20px; background-color: #f8f8f8; border-top-left-radius: 10px;">
  <a href="新增種類.php" style="margin-right: 10px; text-decoration: none;">新增種類</a>
  <a href="新增商品.php" style="text-decoration: none;">新增商品</a>
</div>
</body>
</html>
