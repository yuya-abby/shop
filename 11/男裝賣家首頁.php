...
<table cellspacing="0" cellpadding="0" style="width:100%;">
    ...
    <div class="container">
        <div class="product">
        <img src="img/衣服男1.jpg" style="heigh:200px; width:200px;">
        <h3>衣服男1</h3>
        ...
        <div class="product">
        <img src="img/衣服男2.jpg" style="heigh:200px; width:200px;">
        <h3>衣服男2</h3>
        <a href="#" class="button">立即購買</a>
        <div style="text-align: right;">
            <a href="修改商品.php">修改商品</a>
        ...
        <div class="product">
        <img src="img/衣服男3.jpg" style="heigh:200px; width:200px;">
        <h3>衣服男3</h3>
        <a href="#" class="button">立即購買</a>
        <div style="text-align: right;">
            <a href="修改商品.php">修改商品</a>
        ...
        <div class="product">
        <img src="img/衣服男4.jpg" style="heigh:200px; width:200px;">
        <h3>衣服男4</h3>
        <a href="#" class="button">立即購買</a>
        <div style="text-align: right;">
            <a href="修改商品.php">修改商品</a>
