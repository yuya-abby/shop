...
<table cellspacing="0" cellpadding="0" style="width:100%;">
    ...
    <div class="container">
        <div class="product">
        <img src="img/衣服女1.jpg" style="heigh:200px; width:200px;">
        <h3>女裝1</h3>
        <p>$ 299</p>
        ...
        <div class="product">
        <img src="img/衣服女2.jpg" style="heigh:200px; width:200px;">
        <h3>女裝2</h3>
        <p>$ 299</p>
        <a href="#" class="button">立即購買</a>
        <div style="text-align: right;">
        ...
        <div class="product">
        <img src="img/衣服3.jpg" style="heigh:200px; width:200px;">
        <h3>女裝3</h3>
        <p>$ 299</p>
        <a href="#" class="button">立即購買</a>
        <div style="text-align: right;">
        ...
        <div class="product">
        <img src="img/衣服女4.jpg" style="heigh:200px; width:200px;">
        <h3>女裝4</h3>
        <p>$ 299</p>
        <a href="#" class="button">立即購買</a>
        <div style="text-align: right;">
