...
<div class="banner">
    <table width="100%">
        <tr>
            ...
            <td>
                <form action="msg-after2.php" method="get" style="text-align:right;">
            ...
            <td align="center" style="width: 100px;"><a href="car.php">購物車</a></td>
...
<div class="container">
    <div class="top-actions">
        <input type="button" value="新增留言" onclick="location.href='msg-after.php'">
    </div>
...
if (mysqli_num_rows($res) > 0) {
    while ($row = mysqli_fetch_assoc($res)) {
        ...
        echo "<form action='add-reply.php' method='post'>";
        ...
        while ($reply = mysqli_fetch_assoc($replies)) {
            ...
            if ($_SESSION["account"] == $reply["account"]) {
                echo "<div class='message-actions'>";
                echo "<input type='button' value='刪除' onclick=\"location.href='del.php?id=" . $reply['id'] . "'\">";
                echo "</div>";
            }
            echo "</div>";
        }
