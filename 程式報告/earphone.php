...
<div class="banner"><div class="navbar">
        ...
        <div class="container">
        <div class="product">
        <img src="img/耳機殼1.jpg" style="height:200px; width:200px;">
        <a href="#" class="button" onclick="location.href='count.php'">立即購買</a>
        <h3>耳機殼1</h3>
        </div>

        <div class="product">
        <img src="img/耳機殼2.jpg" style="height:200px; width:200px;">
        <a href="#" class="button" onclick="location.href='count.php'">立即購買</a>
        <h3>耳機殼2</h3>
        </div>
           
        <div class="product">
        <img src="img/耳機殼3.jpg" style="height:200px; width:200px;">
        <a href="#" class="button" onclick="location.href='count.php'">立即購買</a>
        <h3>耳機殼3</h3>
        </div>
        
        <div class="product">
        <img src="img/耳機殼4.jpg" style="height:200px; width:200px;">
        <a href="#" class="button" onclick="location.href='count.php'">立即購買</a>
        <h3>耳機殼4</h3>
        </div>
    </div>
