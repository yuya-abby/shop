...
<div class="banner"><div class="navbar">
        <table cellspacing="0" cellpadding="0" style="width:100%;">
                ...
                <td align="center" style="width:100px; font-size:20px;"><a href="admin.php">編輯權限</a></td>
                <td align="center" style="width:100px; font-size:20px;"><a href="login.php">登出</a></td>
            </tr>
        </table>
        </div></div>
        <form action="add-user2.php" method="get">
        <h4 align="center">歡迎管理員:<?php echo $_SESSION["account"]; ?></h4>
    </form>
...
<table align="center" border="1" style="width:700px">
        ...
        if(mysqli_num_rows($res)>0){
            while($row=mysqli_fetch_assoc($res)){
                    ...
                    echo "<td>".$row["type"]."</td>";
                    echo "<td><input type='button' value='修改(帳號)'onclick=location.href='upp.php?id=".$row['id']."'>
                    <input type='button' value='刪除' onclick=location.href='del3.php?id=".$row["id"]."'></td>";
                     echo "</tr>";
